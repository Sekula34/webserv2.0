...
### Normal request start with test_0_XX_name
	def test_0_01_home_page(self):
	...
	def test_0_09_autoindexSubfolder(self):
	...
	def test_0_10_autoindexThatHaveIndex(self):
	...
	def test_0_11_autoindexBlocked(self):
	...
	def test_0_12_redirection(self):
	...
	def test_0_15_body_size_limit(self):
	...
	def test_0_17_overwrite_file_with_location(self):
		TestMyWebServer.print_test_title("testing owerwrite")
		response = TestMyWebServer.send_get("http://localhost:9090/overwrite")
		self.assertEqual(response.status_code, 200)
		self.assertIn("I am the correct index", response.text)
		Colors.test_passed()

### Custom request start with test_1_XX_name
	def test_1_01_phantom_port(self):
	...
	def test_1_05_contradict_content_length_transfer_encoding(self):
	...
	def test_1_06_short_invalid(self):
...
### CGI test with test_2_XX_name
	def test_2_01_all_cgi_scripts(self):
		...
		cgi_scripts = {"hard.py" : 500, "io_test.py" : 200, "kill.py" : 504, "link_dummy.py" : 500, "loop.py" : 504, "soft.py" : 500, "error.py" : 502, , "error2.py" : 502}
