...
ServerResponse::ServerResponse(ClientHeader& header,
...
ServerResponse::ServerResponse(const ServerResponse& source)
:_clientHeader(source._clientHeader), _server(source._server)
{

}

ServerResponse& ServerResponse::operator=(const ServerResponse& source)
{
	(void)source;
	return (*this);
}
...
void ServerResponse::sendSimpleResponse()const 
{
